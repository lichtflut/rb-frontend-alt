  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved host as @host" do
        ...
        post :create, {:host => { "service_uri" => "invalid value" }}, valid_session
        assigns(:host).should be_a_new(Host)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested host" do
        ...
        Host.any_instance.should_receive(:update_attributes).with({ "service_uri" => "MyString" })
        put :update, {:id => host.to_param, :host => { "service_uri" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the host as @host" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Host.any_instance.stub(:save).and_return(false)
        put :update, {:id => host.to_param, :host => { "service_uri" => "invalid value" }}, valid_session
        assigns(:host).should eq(host)
      end
